		...
		<div class="row main-content bg-success text-center">
			...
			<div class="col-md-8 col-xs-12 col-sm-12 login_form p-3">
				<div class="container-fluid">
					...
					<div class="row">
						<form action="{{ route('signin') }}" method="POST" class="form-group form-custom">
							@csrf
							<div class="row">
					...
					<div class="row">
						<p>Don't have an account? <a href="{{ route('signup.view') }}" class="text-primary text-decoration-none">Register Here</a></p>
					</div>
				</div>
			</div>
		</div>
